...
export async function POST(req: NextRequest) {
  ...
  console.log(`[Delete Activity] Deleting logs for dates:`, dates);

  // Delete daily_logs for these dates in this guild
  ...
  console.log(`✅ Deleted activity logs for ${dates.length} date(s)`);
